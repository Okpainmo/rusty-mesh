...
[Rusty Mesh Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this
...
[Issues](https://github.com/Okpainmo/rusty-mesh/issues) that might help you. In case you have found
...
- Open an [Issue](https://github.com/Okpainmo/rusty-mesh/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are
  ...
  [bug tracker](https://github.com/Okpainmo/rusty-mesh/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/Okpainmo/rusty-mesh/issues/new). (Since we can't be sure at
...
This section guides you through submitting an enhancement suggestion for Rusty Mesh, including
...
- Search [Issues](https://github.com/Okpainmo/rusty-mesh/issues) to see if the enhancement has
...
[GitHub issues](https://github.com/Okpainmo/rusty-mesh/issues).
...
- **Explain why this enhancement would be useful** to most Rusty Mesh users. You may also want to
...
Example: `feat(routing): add weighted service routing`
